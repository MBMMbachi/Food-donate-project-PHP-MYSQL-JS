...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Chikkamagaluru\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $Chikkamagaluru=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"BengaluruRural\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $BengaluruRural=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"Belagavi\"";
...
var xplace=["Chikkamagaluru","BengaluruRural","Belagavi"];
var yplace=[<?php echo json_encode($Chikkamagaluru,JSON_HEX_TAG);?>,<?php echo json_encode($Belagavi,JSON_HEX_TAG);?>,<?php echo json_encode($BengaluruRural,JSON_HEX_TAG);?>];
